import type { ChannelOnboardingAdapter, ThinkFleetBotConfig, WizardPrompter } from "thinkfleetbot/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.thinkfleet.dev/channels/mattermost",
    ].join("\n"),
...
export const mattermostOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  disable: (cfg: ThinkFleetBotConfig) => ({
    ...cfg,
    channels: {
      ...cfg.channels,
