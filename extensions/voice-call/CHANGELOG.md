...
### Changes
- Version alignment with core ThinkFleetBot release numbers.
...
### Highlights
- First public release of the @thinkfleetbot/voice-call plugin.
...
- CLI: `thinkfleetbot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
