...
const CLIENT_ID_KEYS = ["THINKFLEETBOT_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
const CLIENT_SECRET_KEYS = [
  "THINKFLEETBOT_GEMINI_OAUTH_CLIENT_SECRET",
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to ThinkFleetBot.</p></body></html>",
        );
...
async function discoverProject(accessToken: string): Promise<string> {
  ...
  const headers = {
    ...
    "X-Goog-Api-Client": "gl-node/thinkfleetbot",
  };
