...
function setMSTeamsDmPolicy(cfg: ThinkFleetBotConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: ThinkFleetBotConfig, allowFrom: string[]): ThinkFleetBotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
