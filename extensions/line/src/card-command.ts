import type { ThinkFleetBotPluginApi, LineChannelData, ReplyPayload } from "thinkfleetbot/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: ThinkFleetBotPluginApi): void {
  api.registerCommand({
    name: "card",
