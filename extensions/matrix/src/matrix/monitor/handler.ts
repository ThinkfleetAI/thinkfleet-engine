...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: typeof import("thinkfleetbot/plugin-sdk")["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    typeof import("thinkfleetbot/plugin-sdk")["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "ThinkFleetBot: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
