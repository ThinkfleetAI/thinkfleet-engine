...
const tlonOutbound: ChannelOutboundAdapter = {
  ...
  sendText: async ({ cfg, to, text, accountId, replyToId, threadId }) => {
    const account = resolveTlonAccount(cfg as ThinkFleetBotConfig, accountId ?? undefined);
...
export const tlonPlugin: ChannelPlugin = {
  ...
  config: {
    listAccountIds: (cfg) => listTlonAccountIds(cfg as ThinkFleetBotConfig),
    resolveAccount: (cfg, accountId) => resolveTlonAccount(cfg as ThinkFleetBotConfig, accountId ?? undefined),
  ...
  setup: {
    ...
    validateInput: ({ cfg, accountId, input }) => {
      ...
      const resolved = resolveTlonAccount(cfg as ThinkFleetBotConfig, accountId ?? undefined);
