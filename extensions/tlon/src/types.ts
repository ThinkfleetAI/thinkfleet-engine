...
export function resolveTlonAccount(cfg: ThinkFleetBotConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: ThinkFleetBotConfig): string[] {
  const base = cfg.channels?.tlon as
