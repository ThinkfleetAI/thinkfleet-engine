...
import { removeAckReactionAfterReply, shouldAckReaction } from "thinkfleetbot/plugin-sdk";
import type { ThinkFleetBotConfig, PluginRuntime } from "thinkfleetbot/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/thinkfleetbot") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
...
describe("BlueBubbles webhook monitor", () => {
  ...
  describe("webhook parsing + auth handling", () => {
    it("rejects non-POST requests", async () => {
      ...
      const config: ThinkFleetBotConfig = {};
