...
ThinkFleetBot defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, ThinkFleetBot inspects the OS preference (macOS/Windows)
