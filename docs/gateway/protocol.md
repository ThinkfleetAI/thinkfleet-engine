...
ThinkFleetBot. All clients (CLI, web UI, macOS app, iOS/Android nodes, headless
...
```json
{
  ...
  "params": {
    ...
    "auth": { "token": "…" },
    "locale": "en-US",
    "userAgent": "thinkfleetbot-cli/1.2.3",
    "device": {
...
```json
{
  ...
  "params": {
    ...
    "auth": { "token": "…" },
    "locale": "en-US",
    "userAgent": "thinkfleetbot-ios/1.2.3",
    "device": {
      "id": "device_fingerprint",
      "publicKey": "…",
      "signature": "…",
...
- If `THINKFLEETBOT_GATEWAY_TOKEN` (or `--token`) is set, `connect.params.auth.token`
