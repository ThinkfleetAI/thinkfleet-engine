...
ThinkFleetBot’s Gateway can serve an OpenResponses-compatible `POST /v1/responses` endpoint.
...
`thinkfleetbot agent`), so routing/permissions/config match your Gateway.
