...
- Install via CLI: `thinkfleetbot plugins install @thinkfleetbot/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `thinkfleetbot plugins install ./extensions/zalo`
   - From npm (if published): `thinkfleetbot plugins install @thinkfleetbot/zalo`
...
- Approve via:
  - `thinkfleetbot pairing list zalo`
  - `thinkfleetbot pairing approve zalo <CODE>`
...
- Example: `thinkfleetbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `thinkfleetbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `thinkfleetbot logs --follow`
