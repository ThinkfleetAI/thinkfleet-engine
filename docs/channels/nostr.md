...
read_when:
  - You want ThinkFleetBot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables ThinkFleetBot to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`thinkfleetbot onboard`) and `thinkfleetbot channels add` list optional channel plugins.
...
```bash
thinkfleetbot plugins install @thinkfleetbot/nostr
```

Use a local checkout (dev workflows):

```bash
thinkfleetbot plugins install --link <path-to-thinkfleetbot>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "thinkfleetbot",
        "displayName": "ThinkFleetBot",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "thinkfleetbot@example.com",
        "lud16": "thinkfleetbot@example.com"
      }
    }
  }
}
