...
- Same path: run the app from a fixed location (for ThinkFleetBot, `dist/ThinkFleetBot.app`).
...
```bash
sudo tccutil reset Accessibility ai.thinkfleet.mac
sudo tccutil reset ScreenCapture ai.thinkfleet.mac
