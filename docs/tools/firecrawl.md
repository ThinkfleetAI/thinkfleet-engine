...
ThinkFleetBot can use **Firecrawl** as a fallback extractor for `web_fetch`. It is a hosted
...
ThinkFleetBot always uses `proxy: "auto"` plus `storeInCache: true` for Firecrawl requests.
