...
ThinkFleetBot controls a **dedicated Chrome profile** (named `clawd`, orange‑tinted UI). This is separate from your daily browser profile.
...
```bash
thinkfleetbot browser open https://x.com --browser-profile clawd --target host
```
