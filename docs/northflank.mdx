...
Deploy ThinkFleetBot on Northflank with a one-click template and finish setup in your browser.
...
1. Click [Deploy ThinkFleetBot](https://northflank.com/stacks/deploy-thinkfleetbot) to open the template.  
2. Create an [account on Northflank](https://app.northflank.com/signup) if you don’t already have one.  
3. Click **Deploy ThinkFleetBot now**.  
4. Set the required environment variable: `SETUP_PASSWORD`.
5. Click **Deploy stack** to build and run the ThinkFleetBot template.
6. Wait for the deployment to complete, then click **View resources**.
7. Open the ThinkFleetBot service.
8. Open the public ThinkFleetBot URL and complete setup at `/setup`.
9. Open the Control UI at `/thinkfleetbot`.
...
4) Click **Run setup**.
5) Open the Control UI at `https://<your-northflank-domain>/thinkfleetbot`
