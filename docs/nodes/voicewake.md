...
ThinkFleetBot treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.thinkfleetbot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["managed", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
