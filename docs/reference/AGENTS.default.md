---
summary: "Default ThinkFleetBot agent instructions and skills roster for the personal assistant setup"
read_when:
  - Starting a new ThinkFleetBot agent session
  - Enabling or auditing default skills
---
# AGENTS.md — ThinkFleetBot Personal Assistant (default)
...
## What ThinkFleetBot Does
- Runs WhatsApp gateway + Pi coding agent so the assistant can read/write chats, fetch context, and run skills via the host Mac.
- macOS app manages permissions (screen recording, notifications, microphone) and exposes the `thinkfleetbot` CLI via its bundled binary.
...
## Usage Notes
- Prefer the `thinkfleetbot` CLI for scripting; mac app handles permissions.
