...
This page ties together how ThinkFleetBot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. ThinkFleetBot keeps a
...
ThinkFleetBot separates the **prompt body** from the **command body**:
...
ThinkFleetBot can expose or hide model reasoning:
