...
read_when:
  - You want to understand what “context” means in ThinkFleetBot
  - You are debugging why the model “knows” something (or forgot it)
  - You want to reduce context overhead (/context, /status, /compact)
---
# Context

“Context” is **everything ThinkFleetBot sends to the model for a run**. It is bounded by the model’s **context window** (token limit).

Beginner mental model:
- **System prompt** (ThinkFleetBot-built): rules, tools, skills list, time/runtime, and injected workspace files.
...
## How ThinkFleetBot builds the system prompt

The system prompt is **ThinkFleetBot-owned** and rebuilt each run. It includes:
...
By default, ThinkFleetBot injects a fixed set of workspace files (if present):
- `AGENTS.md`
- `SOUL.md`
- `TOOLS.md`
- `IDENTITY.md`
