...
ThinkFleetBot formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** — see [docs](https://docs.thinkfleet.dev).
```
...
```json
{
  ...
  "links": [
    { "start": 19, "end": 23, "href": "https://docs.thinkfleet.dev" }
  ]
}
```
