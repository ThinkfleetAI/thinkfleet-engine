...
ThinkFleetBot treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)
ThinkFleetBot “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, ThinkFleetBot can see that group and respond there.

Default behavior:
- Groups are restricted (`groupPolicy: "allowlist"`).
- Replies require a mention unless you explicitly disable mention gating.

Translation: allowlisted senders can trigger ThinkFleetBot by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@thinkfleet", "thinkfleetbot", "\\+15555550123"],
          historyLimit: 50
        }
      }
    ]
