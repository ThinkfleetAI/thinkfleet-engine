---
summary: "Backstory and lore of ThinkFleetBot for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
---
# The Lore of ThinkFleetBot 🦞📖
...
For a while, the lobster was called **Clawd**, living in a **ThinkFleetBot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in a **ThinkFleetBot**. New shell, same lobster soul.

## The Molt (January 27, 2026)

At 5am, the community gathered in Discord. Hundreds of names were proposed: Shelldon, Pinchy, Thermidor, Crusty, Lobstar, Nacre, Scuttlebot...

In the end, **ThinkFleetBot** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/thinkfleet/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around ThinkFleetBot. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with thinkfleetbot."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @thinkfleetbot. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at ThinkFleetBot" to promote pump-and-dump tokens.
