...
read_when:
  - You want to place an outbound voice call from ThinkFleetBot
  - You are configuring or developing the voice-call plugin
---

# Voice Call (plugin)

Voice calls for ThinkFleetBot via a plugin. Supports outbound notifications and
...
- Use `thinkfleetbot voicecall ...` or the `voice_call` tool
...
```bash
thinkfleetbot plugins install ./extensions/voice-call
