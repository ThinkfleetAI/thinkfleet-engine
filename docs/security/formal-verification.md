...
summary: Machine-checked security models for ThinkFleetBot’s highest-risk paths.
permalink: /security/formal-verification/
---

# Formal Verification (Security Models)

This page tracks ThinkFleetBot’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that ThinkFleetBot enforces its
...
**What this is not (yet):** a proof that “ThinkFleetBot is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/thinkfleetbot-formal-models](https://github.com/vignesh07/thinkfleetbot-formal-models).
...
```bash
git clone https://github.com/vignesh07/thinkfleetbot-formal-models
cd thinkfleetbot-formal-models
