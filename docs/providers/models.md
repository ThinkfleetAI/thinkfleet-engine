---
summary: "Model providers (LLMs) supported by ThinkFleetBot"
read_when:
...
ThinkFleetBot can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `thinkfleetbot onboard`).
