---
summary: "Use Qwen OAuth (free tier) in ThinkFleetBot"
read_when:
  - You want to use Qwen with ThinkFleetBot
...
```bash
thinkfleetbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, ThinkFleetBot will sync credentials
