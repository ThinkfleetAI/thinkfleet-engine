---
summary: "Use MiniMax M2.1 in ThinkFleetBot"
read_when:
  - You want MiniMax models in ThinkFleetBot
...
Configure manually via `thinkfleetbot.json`:
...
- Use `thinkfleetbot models list` and `thinkfleetbot models set minimax/MiniMax-M2.1` to switch.
...
- Running `thinkfleetbot configure` and selecting **MiniMax M2.1**, or
