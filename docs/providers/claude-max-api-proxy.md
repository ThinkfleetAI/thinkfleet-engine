...
You can point ThinkFleetBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ThinkFleetBot
...
- [Anthropic provider](/providers/anthropic) - Native ThinkFleetBot integration with Claude setup-token or API keys
