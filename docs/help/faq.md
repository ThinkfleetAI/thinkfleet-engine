---
summary: "Frequently asked questions about ThinkFleetBot setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up ThinkFleetBot?](#whats-the-recommended-way-to-install-and-set-up-thinkfleetbot)
...
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  ...
  - [Windows install says git not found or thinkfleetbot not recognized](#windows-install-says-git-not-found-or-thinkfleetbot-not-recognized)
  ...
  - [If I buy a Mac mini to run ThinkFleetBot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-thinkfleetbot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different ThinkFleetBots?](#can-multiple-people-use-one-whatsapp-number-with-different-thinkfleetbots)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run ThinkFleetBot on a dedicated machine?](#how-important-is-it-to-run-thinkfleetbot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run ThinkFleetBot in a VM and what are the requirements](#can-i-run-thinkfleetbot-in-a-vm-and-what-are-the-requirements)
- [What is ThinkFleetBot?](#what-is-thinkfleetbot)
  - [What is ThinkFleetBot, in one paragraph?](#what-is-thinkfleetbot-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for ThinkFleetBot](#what-are-the-top-five-everyday-use-cases-for-thinkfleetbot)
  - [Can ThinkFleetBot help with lead gen outreach ads and blogs for a SaaS](#can-thinkfleetbot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can ThinkFleetBot run tasks on a schedule or continuously in the background?](#can-thinkfleetbot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with ThinkFleetBot saved locally?](#is-all-data-used-with-thinkfleetbot-saved-locally)
  - [Where does ThinkFleetBot store its data?](#where-does-thinkfleetbot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall ThinkFleetBot?](#how-do-i-completely-uninstall-thinkfleetbot)
...
- [Config basics](#config-basics)
  ...
  - [Can the ThinkFleetBot browser run headless?](#can-the-thinkfleetbot-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two ThinkFleetBots talk to each other (local + VPS)?](#can-two-thinkfleetbots-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does ThinkFleetBot load environment variables?](#how-does-thinkfleetbot-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of ThinkFleetBots one CEO and many agents](#is-there-a-way-to-make-a-team-of-thinkfleetbots-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset ThinkFleetBot but keep it installed?](#how-do-i-completely-reset-thinkfleetbot-but-keep-it-installed)
  ...
  - [Why doesn’t ThinkFleetBot reply in a group?](#why-doesnt-thinkfleetbot-reply-in-a-group)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `thinkfleetbot gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-thinkfleetbot-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `thinkfleetbot gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-thinkfleetbot-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run ThinkFleetBot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-thinkfleetbot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart ThinkFleetBot?](#i-closed-my-terminal-on-windows-how-do-i-restart-thinkfleetbot)
  ...
  - [ELI5: `thinkfleetbot gateway restart` vs `thinkfleetbot gateway`](#eli5-thinkfleetbot-gateway-restart-vs-thinkfleetbot-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose ThinkFleetBot to inbound DMs?](#is-it-safe-to-expose-thinkfleetbot-to-inbound-dms)
...
1) **Quick status (first check)**
   ```bash
   thinkfleetbot status
   ```
   Fast local summary: OS + update, gateway/service reachability, agents/sessions, provider config + runtime issues (when gateway is reachable).

2) **Pasteable report (safe to share)**
   ```bash
   thinkfleetbot status --all
   ```
   Read-only diagnosis with log tail (tokens redacted).

3) **Daemon + port state**
   ```bash
   thinkfleetbot gateway status
   ```
   Shows supervisor runtime vs RPC reachability, the probe target URL, and which config the service likely used.

4) **Deep probes**
   ```bash
   thinkfleetbot status --deep
   ```
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/thinkfleetbot/thinkfleetbot-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ...
   thinkfleetbot health --verbose   # shows the target URL + config path on errors
   ```
...
What they do:
- `thinkfleetbot status`: quick snapshot of gateway/agent health + basic config.
- `thinkfleetbot models status`: checks provider auth + model availability.
- `thinkfleetbot doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `thinkfleetbot status --all`, `thinkfleetbot logs --follow`,
`thinkfleetbot gateway status`, `thinkfleetbot health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up ThinkFleetBot
...
If you don’t have a global install yet, run it via `pnpm thinkfleetbot onboard`.
...
Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-thinkfleetbot-store-its-data),
...
```bash
thinkfleetbot update --channel dev
```
...
### Windows install says git not found or thinkfleetbot not recognized
...
**2) thinkfleetbot is not recognized after install**
...
### How do I install ThinkFleetBot on Linux
...
### How do I install ThinkFleetBot on a VPS
...
thinkfleetbot update status
thinkfleetbot update --channel stable|beta|dev
thinkfleetbot update --tag <dist-tag|version>
thinkfleetbot update --no-restart
```

If you must automate from an agent:

```bash
thinkfleetbot update --yes --no-restart
thinkfleetbot gateway restart
```
...
No. You can run ThinkFleetBot with **API keys** (Anthropic/OpenAI/others) or with
...
Yes — via **setup-token**. ThinkFleetBot no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so ThinkFleetBot can keep replying while a provider is rate‑limited.
...
ThinkFleetBot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. ThinkFleetBot fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `thinkfleetbot.json`.

Steps:
1) Enable the plugin: `thinkfleetbot plugins enable google-gemini-cli-auth`
2) Login: `thinkfleetbot models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. ThinkFleetBot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. ThinkFleetBot runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. ThinkFleetBot’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run ThinkFleetBot can I connect it to my MacBook Pro
...
- DM your bot, then run `thinkfleetbot logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different ThinkFleetBots
...
If you run ThinkFleetBot via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
```bash
npm install -g thinkfleetbot@latest
thinkfleetbot doctor
thinkfleetbot gateway restart
```
...
**ThinkFleetBot-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run ThinkFleetBot on a dedicated machine
...
ThinkFleetBot is lightweight. For a basic Gateway + one chat channel:
...
### Can I run ThinkFleetBot in a VM and what are the requirements
...
## What is ThinkFleetBot?

### What is ThinkFleetBot in one paragraph

ThinkFleetBot is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

ThinkFleetBot is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for ThinkFleetBot
...
### Can ThinkFleetBot help with lead gen outreach ads and blogs for a SaaS
...
ThinkFleetBot draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

ThinkFleetBot is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use ThinkFleetBot when you
...
Checklist:
- Confirm cron is enabled (`cron.enabled`) and `THINKFLEETBOT_SKIP_CRON` is not set.
- Check the Gateway is running 24/7 (no sleep/restarts).
- Verify timezone settings for the job (`--tz` vs host timezone).

Debug:
```bash
thinkfleetbot cron run <jobId> --force
thinkfleetbot cron runs --id <jobId> --limit 50
```
...
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-thinkfleetbot-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. ThinkFleetBot can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.thinkfleetbot/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"thinkfleetbot":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (ThinkFleetBot only needs stdio). See [iMessage](/channels/imessage).
...
ThinkFleetBot memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

ThinkFleetBot also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, ThinkFleetBot auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, ThinkFleetBot
prefers `local`.
...
### Is all data used with ThinkFleetBot saved locally

No - **ThinkFleetBot’s state is local**, but **external services still see what you send them**.
...
### Where does ThinkFleetBot store its data

Everything lives under `$THINKFLEETBOT_STATE_DIR` (default: `~/.thinkfleetbot`):

| Path | Purpose |
|------|---------|
| `$THINKFLEETBOT_STATE_DIR/thinkfleetbot.json` | Main config (JSON5) |
| `$THINKFLEETBOT_STATE_DIR/credentials/oauth.json` | Legacy OAuth import (copied into auth profiles on first use) |
| `$THINKFLEETBOT_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys) |
| `$THINKFLEETBOT_STATE_DIR/agents/<agentId>/agent/auth.json` | Runtime auth cache (managed automatically) |
| `$THINKFLEETBOT_STATE_DIR/credentials/` | Provider state (e.g. `whatsapp/<accountId>/creds.json`) |
| `$THINKFLEETBOT_STATE_DIR/agents/` | Per‑agent state (agentDir + sessions) |
| `$THINKFLEETBOT_STATE_DIR/agents/<agentId>/sessions/` | Conversation history & state (per agent) |
| `$THINKFLEETBOT_STATE_DIR/agents/<agentId>/sessions/sessions.json` | Session metadata (per agent) |
...
These files live in the **agent workspace**, not `~/.thinkfleetbot`.
...
### How do I completely uninstall ThinkFleetBot
...
`workspace` to the repo root. The ThinkFleetBot repo is just source code; keep the
...
ThinkFleetBot reads an optional **JSON5** config from `$THINKFLEETBOT_CONFIG_PATH` (default: `~/.thinkfleetbot/thinkfleetbot.json`):
...
Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `THINKFLEETBOT_GATEWAY_TOKEN`).
...
- Daemons read env vars from `~/.thinkfleetbot/.env` (or the service environment).
...
### Can the ThinkFleetBot browser run headless
...
Check the basics:
- Gateway is running: `thinkfleetbot gateway status`
- Gateway health: `thinkfleetbot status`
- Channel health: `thinkfleetbot channels status`
...
### Can two ThinkFleetBots talk to each other local VPS
...
Recover:
- Restore from backup (git or a copied `~/.thinkfleetbot/thinkfleetbot.json`).
- If you have no backup, re-run `thinkfleetbot doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `thinkfleetbot config set` for small changes.
- Use `thinkfleetbot configure` for interactive edits.
...
```bash
thinkfleetbot gateway --tailscale serve
```
...
### How does ThinkFleetBot load environment variables

ThinkFleetBot reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.thinkfleetbot/.env` (aka `$THINKFLEETBOT_STATE_DIR/.env`)
...
1) Put the missing keys in `~/.thinkfleetbot/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
does **not** mean your env vars are missing - it just means ThinkFleetBot won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.thinkfleetbot/.env`:
   ```
...
### Is there a way to make a team of ThinkFleetBots one CEO and many agents
...
### How do I completely reset ThinkFleetBot but keep it installed
...
```bash
thinkfleetbot reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `THINKFLEETBOT_PROFILE`), reset each state dir (defaults are `~/.thinkfleetbot-<profile>`).
- Dev reset: `thinkfleetbot gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), ThinkFleetBot skips the heartbeat run to save API calls.
...
No. ThinkFleetBot runs on **your own account**, so if you’re in the group, ThinkFleetBot can see it.
...
```bash
thinkfleetbot logs --follow --json
```
...
```bash
thinkfleetbot directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt ThinkFleetBot reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.thinkfleetbot/agents/<agentId>/sessions/`.
...
- Use `thinkfleetbot doctor` to spot stray workspaces and profile mismatches.
...
ThinkFleetBot’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, ThinkFleetBot currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `thinkfleetbot models set ...` (updates just model config)
- `thinkfleetbot configure --section models` (interactive)
...
Yes. ThinkFleetBot ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.thinkfleetbot/agents/<agentId>/agent/auth-profiles.json
```

Fix options:
- Run `thinkfleetbot agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so ThinkFleetBot can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.thinkfleetbot/agents/<agentId>/agent/auth-profiles.json`
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), ThinkFleetBot will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: ThinkFleetBot now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
ThinkFleetBot uses provider‑prefixed IDs like:
...
ThinkFleetBot may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `thinkfleetbot models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
thinkfleetbot models auth order set --provider anthropic anthropic:work anthropic:default
...
```
--port > THINKFLEETBOT_GATEWAY_PORT > gateway.port > default 18789
```

### Why does thinkfleetbot gateway status say Runtime running but RPC probe failed
...
### Why does thinkfleetbot gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `THINKFLEETBOT_STATE_DIR` mismatch).

Fix:
```bash
thinkfleetbot gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

ThinkFleetBot enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `thinkfleetbot gateway --port <port>`.

### How do I run ThinkFleetBot in remote mode client connects to a Gateway elsewhere
...
Notes:
- `thinkfleetbot gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `thinkfleetbot.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `thinkfleetbot dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `thinkfleetbot doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `THINKFLEETBOT_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `thinkfleetbot status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
Profiles also suffix service names (`ai.thinkfleet.<profile>`; legacy `com.thinkfleetbot.*`, `thinkfleetbot-gateway-<profile>.service`, `ThinkFleetBot Gateway (<profile>)`).
...
```
thinkfleetbot tui --url ws://<host>:18789 --token <token>
```
...
- Linux: `journalctl --user -u thinkfleetbot-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "ThinkFleetBot Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `thinkfleetbot gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart ThinkFleetBot
...
1) Is the Gateway running? `thinkfleetbot gateway status`
2) Is the Gateway healthy? `thinkfleetbot status`
3) Does the UI have the right token? `thinkfleetbot dashboard`
...
```bash
thinkfleetbot channels status
thinkfleetbot channels logs --channel telegram
```
...
### ELI5 thinkfleetbot gateway restart vs thinkfleetbot gateway

- `thinkfleetbot gateway restart`: restarts the **background service** (launchd/systemd).
- `thinkfleetbot gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `thinkfleetbot gateway` when
...
```bash
thinkfleetbot message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose ThinkFleetBot to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `thinkfleetbot pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `thinkfleetbot pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `thinkfleetbot doctor` to surface risky DM policies.
...
```bash
thinkfleetbot pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. ThinkFleetBot only replies to chats it receives or to explicit sends you trigger.
...
ThinkFleetBot blocks **cross‑provider** messaging by default. If a tool call is bound
