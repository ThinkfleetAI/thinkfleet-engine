...
Deploy ThinkFleetBot on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/thinkfleetbot-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/thinkfleetbot` — Control UI

## What you get

- Hosted ThinkFleetBot Gateway + Control UI
...
- `THINKFLEETBOT_STATE_DIR=/data/.thinkfleetbot` (recommended)
- `THINKFLEETBOT_WORKSPACE_DIR=/data/workspace` (recommended)
- `THINKFLEETBOT_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your ThinkFleetBot state + workspace so you can migrate to another host without losing config or memory.
