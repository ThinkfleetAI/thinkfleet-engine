...
actor CameraController {
    ...
    func snap(params: ThinkFleetBotCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: ThinkFleetBotCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("thinkfleetbot-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("thinkfleetbot-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: ThinkFleetBotCameraFacing,
