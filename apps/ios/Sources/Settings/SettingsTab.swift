...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = ThinkFleetBotLocationMode.off.rawValue
        ...
        NavigationStack {
            Form {
                ...
                Section("Screen") {
                    ...
                    Text("Keeps the screen awake while ThinkFleetBot is open.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                }
            }
    ...
    private var locationMode: ThinkFleetBotLocationMode {
        ThinkFleetBotLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
