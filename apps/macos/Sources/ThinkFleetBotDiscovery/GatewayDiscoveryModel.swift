...
public final class GatewayDiscoveryModel {
    ...
    public func start() {
        ...
        for domain in ThinkFleetBotBonjour.gatewayServiceDomains {
            let params = NWParameters.tcp
            params.includePeerToPeer = true
            let browser = NWBrowser(
                for: .bonjour(type: ThinkFleetBotBonjour.gatewayServiceType, domain: domain),
                using: params)
    ...
    public func refreshWideAreaFallbackNow(timeoutSeconds: TimeInterval = 5.0) {
        let domain = ThinkFleetBotBonjour.wideAreaGatewayServiceDomain
    ...
    private func updateGateways(for domain: String) {
        ...
        if domain == ThinkFleetBotBonjour.wideAreaGatewayServiceDomain,
    ...
    private nonisolated static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized.replacingOccurrences(of: " (ThinkFleetBot)", with: "")
