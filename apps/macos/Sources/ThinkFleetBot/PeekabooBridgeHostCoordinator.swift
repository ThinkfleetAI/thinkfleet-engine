...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: ThinkFleetBotPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = ThinkFleetBotPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.thinkfleetbotSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.thinkfleetbotSocketPath, privacy: .public)")
    }
...
@MainActor
private final class ThinkFleetBotPeekabooBridgeServices: PeekabooBridgeServiceProviding {
