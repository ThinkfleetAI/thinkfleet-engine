...
/// Menu contents for the ThinkFleetBot menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About ThinkFleetBot") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "ThinkFleetBot Not Configured"
        case .remote:
            "Remote ThinkFleetBot Active"
        case .local:
            "ThinkFleetBot Active"
        }
    }
