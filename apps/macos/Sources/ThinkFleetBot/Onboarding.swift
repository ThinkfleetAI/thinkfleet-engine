...
enum UIStrings {
    static let welcomeTitle = "Welcome to ThinkFleetBot"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "thinkfleetbot.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ThinkFleetBotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ThinkFleetBotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g thinkfleetbot@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ThinkFleetBotChatViewModel(
