...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case ThinkFleetBotCameraCommand.snap.rawValue,
                 ...
                 ThinkFleetBotCameraCommand.list.rawValue:
                return try await self.handleCameraInvoke(req)
            case ThinkFleetBotLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case ThinkFleetBotSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case ThinkFleetBotSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case ThinkFleetBotSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case ThinkFleetBotSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case ThinkFleetBotSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case ThinkFleetBotCanvasA2UICommand.push.rawValue,
             ThinkFleetBotCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__thinkfleetbot__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func isA2UIReady(poll: Bool = false) async -> Bool {
        ...
        while true {
            do {
                ...
                (() => String(Boolean(globalThis.thinkfleetbotA2UI)))()
                """)
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ThinkFleetBotSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ThinkFleetBotSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: ThinkFleetBotSystemRunParams,
    ...
    private func handleSystemNotify(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ThinkFleetBotSystemNotifyParams.self, from: req.paramsJSON)
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> ThinkFleetBotLocationMode {
        ...
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: ThinkFleetBotNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: ThinkFleetBotCanvasSnapshotFormat,
        maxWidth: Int?,
