...
final class CanvasManager {
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("ThinkFleetBot/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__thinkfleetbot__/a2ui/").absoluteString + "?platform=macos"
    }
