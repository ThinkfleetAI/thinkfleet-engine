...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/thinkfleetbot/thinkfleetbot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/thinkfleetbot/thinkfleetbot")
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "ThinkFleetBotBuildTimestamp") as? String
        else { return nil }
    ...
    private var gitCommit: String {
        Bundle.main.object(forInfoDictionaryKey: "ThinkFleetBotGitCommit") as? String ?? "unknown"
    }
