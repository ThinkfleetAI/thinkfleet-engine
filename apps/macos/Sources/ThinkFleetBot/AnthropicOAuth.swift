...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (ThinkFleetBot token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: ThinkFleetBotOAuthStore.AnthropicOAuthStatus = ThinkFleetBotOAuthStore
...
enum ThinkFleetBotOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let thinkfleetbotOAuthDirEnv = "THINKFLEETBOT_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "ThinkFleetBot OAuth token file not found"
            case .unreadableFile: "ThinkFleetBot OAuth token file not readable"
            case .invalidJSON: "ThinkFleetBot OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in ThinkFleetBot OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "ThinkFleetBot OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.thinkfleetbotOAuthDirEnv]?
