...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: ThinkFleetBotProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": ThinkFleetBotProtocol.AnyCodable("start"),
                "name": ThinkFleetBotProtocol.AnyCodable("bash"),
            ],
            summary: nil)
