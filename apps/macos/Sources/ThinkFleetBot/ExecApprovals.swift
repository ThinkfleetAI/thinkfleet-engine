...
enum ExecApprovalsStore {
    ...
    static func fileURL() -> URL {
        ThinkFleetBotPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ThinkFleetBotPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
