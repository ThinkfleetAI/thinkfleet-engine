...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .thinkfleetbotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ThinkFleetBotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ThinkFleetBotPaths.stateDirURL.path
...
extension Notification.Name {
    static let thinkfleetbotSelectSettingsTab = Notification.Name("thinkfleetbotSelectSettingsTab")
}
