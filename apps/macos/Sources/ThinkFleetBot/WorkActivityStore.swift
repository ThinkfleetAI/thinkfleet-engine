...
final class WorkActivityStore {
    ...
    func handleTool(
        ...
        name: String?,
        meta: String?,
        args: [String: ThinkFleetBotProtocol.AnyCodable]?)
    {
    ...
    private static func buildLabel(
        name: String?,
        meta: String?,
        args: [String: ThinkFleetBotProtocol.AnyCodable]?) -> String
    {
    ...
    private static func wrapToolArgs(_ args: [String: ThinkFleetBotProtocol.AnyCodable]?) -> ThinkFleetKit.AnyCodable? {
    ...
    private static func unwrapJSONValue(_ value: Any) -> Any {
        if let dict = value as? [String: ThinkFleetBotProtocol.AnyCodable] {
            return dict.mapValues { self.unwrapJSONValue($0.value) }
        }
        if let array = value as? [ThinkFleetBotProtocol.AnyCodable] {
