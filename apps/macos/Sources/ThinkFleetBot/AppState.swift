...
final class AppState {
    ...
    var onboardingSeen: Bool {
        didSet { self.ifNotPreview { UserDefaults.standard.set(self.onboardingSeen, forKey: "thinkfleetbot.onboardingSeen") }
        }
    }

    var debugPaneEnabled: Bool {
        didSet {
            self.ifNotPreview { UserDefaults.standard.set(self.debugPaneEnabled, forKey: "thinkfleetbot.debugPaneEnabled") }
    ...
    init(preview: Bool = false) {
        ...
        let onboardingSeen = UserDefaults.standard.bool(forKey: "thinkfleetbot.onboardingSeen")
        self.isPaused = UserDefaults.standard.bool(forKey: pauseDefaultsKey)
        self.launchAtLogin = false
        self.onboardingSeen = onboardingSeen
        self.debugPaneEnabled = UserDefaults.standard.bool(forKey: "thinkfleetbot.debugPaneEnabled")
        ...
        let configRoot = ThinkFleetBotConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ThinkFleetBotConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ThinkFleetBotConfigFile.loadDict()
            ...
            ThinkFleetBotConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/thinkfleetbot"
        state.remoteCliPath = ""
        return state
    }
}
