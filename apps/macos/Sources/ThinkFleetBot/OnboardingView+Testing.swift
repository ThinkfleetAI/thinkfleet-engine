...
extension OnboardingView {
    static func exerciseForTesting() {
        ...
        let gateway = GatewayDiscoveryModel.DiscoveredGateway(
            ...
            sshPort: 2222,
            gatewayPort: 18789,
            cliPath: "/usr/local/bin/thinkfleetbot",
            stableID: "gateway-1",
            debugID: "gateway-1",
            isLocal: false)
