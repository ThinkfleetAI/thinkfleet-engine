...
enum DeviceIdentityPaths {
    ...
    static func stateDirURL() -> URL {
        ...
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("thinkfleetbot", isDirectory: true)
        }

        return FileManager.default.temporaryDirectory.appendingPathComponent("thinkfleetbot", isDirectory: true)
    }
}
