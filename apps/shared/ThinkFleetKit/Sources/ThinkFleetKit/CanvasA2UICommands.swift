...
public enum ThinkFleetBotCanvasA2UICommand: String, Codable, Sendable {
...
public struct ThinkFleetBotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ThinkFleetBotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
