...
@MainActor
public struct ThinkFleetBotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ThinkFleetBotChatViewModel
    ...
    public init(
        viewModel: ThinkFleetBotChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                ThinkFleetBotChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [ThinkFleetBotChatMessage] {
        let base: [ThinkFleetBotChatMessage]
    ...
    private func mergeToolResults(in messages: [ThinkFleetBotChatMessage]) -> [ThinkFleetBotChatMessage] {
        ...
        for message in messages {
            ...
            let merged = ThinkFleetBotChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: ThinkFleetBotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ThinkFleetBotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ThinkFleetBotChatMessage) -> String {
