## ThinkFleetBot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_thinkfleetbot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm thinkfleetbot gateway --port 18789 --verbose
```
