...
object ThinkFleetBotCanvasA2UIAction {
  ...
  fun jsDispatchA2UIActionStatus(actionId: String, ok: Boolean, error: String?): String {
    ...
    return "window.dispatchEvent(new CustomEvent('thinkfleetbot:a2ui-action-status', { detail: { id: \"${idEscaped}\", ok: ${okLiteral}, error: \"${err}\" } }));"
  }
}
