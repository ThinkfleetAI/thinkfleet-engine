  ...
  LazyColumn(
      ...
      AnimatedVisibility(visible = voiceWakeMode != VoiceWakeMode.Off) {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
          ListItem(
            ...
            supportingContent = { Text("Listens only while ThinkFleetBot is open.") },
            trailingContent = {
              RadioButton(
    ...
    item {
      Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
        ...
        ListItem(
          ...
          supportingContent = { Text("Only while ThinkFleetBot is open.") },
          trailingContent = {
            RadioButton(
    ...
    item {
      ListItem(
        ...
        supportingContent = { Text("Keeps the screen awake while ThinkFleetBot is open.") },
