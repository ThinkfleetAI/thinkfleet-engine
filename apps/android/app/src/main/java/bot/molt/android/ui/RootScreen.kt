  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("ThinkFleetBotWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            override fun onReceivedError(
              ...
              Log.e("ThinkFleetBotWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              if (isDebuggable) {
                Log.d("ThinkFleetBotWebView", "onPageFinished: $url")
              }
...
private class CanvasA2UIActionBridge(private val onMessage: (String) -> Unit) {
  ...
  companion object {
    const val interfaceName: String = "thinkfleetbotCanvasA2UIAction"
  }
}
