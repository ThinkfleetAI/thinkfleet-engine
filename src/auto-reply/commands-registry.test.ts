...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@thinkfleet", { botUsername: "thinkfleet" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@thinkfleet args", {
        botUsername: "thinkfleet",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@thinkfleet: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "thinkfleet" })).toBe(
      "/help@otherbot",
    );
  });
