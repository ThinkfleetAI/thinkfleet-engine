...
function resolveMentionPatterns(cfg: ThinkfleetConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: ThinkfleetConfig | undefined, agentId?: string): RegExp[] {
