...
export const A2UI_PATH = "/__thinkfleet__/a2ui";
export const CANVAS_HOST_PATH = "/__thinkfleet__/canvas";
export const CANVAS_WS_PATH = "/__thinkfleet/ws";
...
(() => {
  ...
  const handlerNames = ["thinkfleetCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Thinkfleet = globalThis.Thinkfleet ?? {};
  globalThis.Thinkfleet.postMessage = postToNode;
  globalThis.Thinkfleet.sendUserAction = sendUserAction;
  globalThis.thinkfleetPostMessage = postToNode;
  globalThis.thinkfleetSendUserAction = sendUserAction;
  globalThis.thinkfleetPostMessage = postToNode;
  globalThis.thinkfleetSendUserAction = sendUserAction;
