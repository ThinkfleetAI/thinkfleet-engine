const DEFAULT_TAGLINE = "Your fleet of AI agents, one command away.";
...
const TAGLINES: string[] = [
  "Your terminal just got smarter—type something and let the fleet handle the busywork.",
  ...
  "Automation with speed: minimal fuss, maximal impact.",
  ...
  "Fleet deployed, commit in—let's ship something mildly responsible.",
  "I'll streamline your workflow: fast, efficient, effective.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.THINKFLEET_TAGLINE_INDEX;
