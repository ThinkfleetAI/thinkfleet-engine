...
${formatHelpExamples([
  ['thinkfleet message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'thinkfleet message send --target +15555550123 --message "Hi" --media photo.jpg',
    "Send a message with media.",
  ],
  [
    'thinkfleet message poll --channel discord --target channel:123 --poll-question "Snack?" --poll-option Pizza --poll-option Sushi',
    "Create a Discord poll.",
  ],
  [
    'thinkfleet message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.thinkfleet.ai/cli/message")}`,
    )
    .action(() => {
