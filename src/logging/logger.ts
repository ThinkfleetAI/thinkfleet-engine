...
export const DEFAULT_LOG_DIR = "/tmp/thinkfleet";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "thinkfleet.log"); // legacy single-file path

const LOG_PREFIX = "thinkfleet";
...
function resolveSettings(): ResolvedSettings {
  let cfg: ThinkfleetConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => ThinkfleetConfig;
      };
