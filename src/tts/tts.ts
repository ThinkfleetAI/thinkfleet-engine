...
export function resolveTtsConfig(cfg: ThinkfleetConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.THINKFLEET_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: ThinkfleetConfig): string | undefined {
