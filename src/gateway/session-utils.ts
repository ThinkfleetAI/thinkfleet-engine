...
import { type ThinkfleetConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ThinkfleetConfig): string[] {
...
export function listAgentsForGateway(cfg: ThinkfleetConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ThinkfleetConfig): string {
...
function resolveSessionStoreAgentId(cfg: ThinkfleetConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: ThinkfleetConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: ThinkfleetConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: ThinkfleetConfig): GatewaySessionsDefaults {
