...
import type { ThinkfleetConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: ThinkfleetConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: ThinkfleetConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: ThinkfleetConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: ThinkfleetConfig) => void;
  log: {
