...
function resolveAnthropicDefaultAuthMode(cfg: ThinkfleetConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyTalkApiKey(config: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyModelDefaults(cfg: ThinkfleetConfig): ThinkfleetConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyLoggingDefaults(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyContextPruningDefaults(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyCompactionDefaults(cfg: ThinkfleetConfig): ThinkfleetConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
