...
import { ThinkfleetSchema } from "./zod-schema.js";
...
export type ConfigSchema = ReturnType<typeof ThinkfleetSchema.toJSONSchema>;
...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.exa.searchType": "Exa Search Type",
  ...
  "agents.defaults.memu": "MemU Hierarchical Memory",
  "agents.defaults.memu.enabled": "Enable MemU Integration",
  "agents.defaults.memu.baseUrl": "MemU Sidecar Base URL",
  "agents.defaults.memu.autoMemorize": "Auto-Memorize Session Turns",
  "agents.defaults.memu.proactive": "Enable Proactive Retrieval",
  "agents.defaults.memu.debounceMs": "Auto-Memorize Debounce (ms)",
...
const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when Thinkfleet writes the config.",
  ...
  "gateway.controlUi.basePath":
    "Optional URL prefix where the Control UI is served (e.g. /thinkfleet).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $THINKFLEET_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.thinkfleet/memory/{agentId}.sqlite).",
  ...
  "plugins.installs":
    "CLI-managed install metadata (used by `thinkfleet plugins update` to locate install sources).",
  "plugins.installs.*.source": 'Install source ("npm", "archive", or "path").',
  "plugins.installs.*.spec": "Original npm spec used for install (if source is npm).",
  "plugins.installs.*.sourcePath": "Original archive/path used for install (if any).",
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.thinkfleet/extensions/<id>).",
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const schema = ThinkfleetSchema.toJSONSchema({
    target: "draft-07",
    unrepresentable: "any",
  });
  schema.title = "ThinkfleetConfig";
