...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveThinkfleetAgentDir() returns mainAgentDir
    process.env.THINKFLEET_STATE_DIR = tmpDir;
    process.env.THINKFLEET_AGENT_DIR = mainAgentDir;
