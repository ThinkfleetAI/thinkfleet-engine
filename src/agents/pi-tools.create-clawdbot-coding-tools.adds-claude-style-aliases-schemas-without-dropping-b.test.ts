...
describe("createThinkfleetCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createThinkfleetCodingTools({
      config,
    ...
    const anthropicTools = createThinkfleetCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createThinkfleetCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createThinkfleetCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
