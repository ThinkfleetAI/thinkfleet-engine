...
function resolveAvatarSource(cfg: ThinkfleetConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ThinkfleetConfig, agentId: string): AgentAvatarResolution {
