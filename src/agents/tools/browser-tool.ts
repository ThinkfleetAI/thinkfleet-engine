...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      'Profiles: use profile="chrome" for Chrome extension relay takeover (your existing Chrome tabs). Use profile="clawd" for the isolated thinkfleet-managed browser.',
