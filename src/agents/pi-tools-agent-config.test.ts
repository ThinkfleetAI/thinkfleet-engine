...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: ThinkfleetConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/thinkfleet-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createThinkfleetCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createThinkfleetCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createThinkfleetCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createThinkfleetCodingTools({
      config: cfg,
    ...
    const bobTools = createThinkfleetCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createThinkfleetCodingTools({
      config: cfg,
