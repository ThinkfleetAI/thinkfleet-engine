...
import type { ThinkfleetConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: ThinkfleetConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: ThinkfleetConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "thinkfleet-bundled";
}

export function resolveBundledAllowlist(config?: ThinkfleetConfig): string[] | undefined {
