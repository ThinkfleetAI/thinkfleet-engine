...
function resolveWatchPaths(workspaceDir: string, config?: ThinkfleetConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ThinkfleetConfig }) {
