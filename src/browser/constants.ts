export const DEFAULT_MANAGED_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_MANAGED_BROWSER_COLOR = "#FF4500";
export const DEFAULT_MANAGED_BROWSER_PROFILE_NAME = "thinkfleet";
