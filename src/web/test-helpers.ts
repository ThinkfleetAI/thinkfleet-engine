...
const CONFIG_KEY = Symbol.for("thinkfleet:testConfigMock");
...
vi.mock("@whiskeysockets/baileys", () => {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("thinkfleet:lastSocket")] =
    created.lastSocket;
  return created.mod;
});
...
export function getLastSocket(): MockBaileysSocket {
  const getter = (globalThis as Record<PropertyKey, unknown>)[Symbol.for("thinkfleet:lastSocket")];
