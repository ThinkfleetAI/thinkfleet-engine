...
export function listBindings(cfg: ThinkfleetConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: ThinkfleetConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ThinkfleetConfig) {
