...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.thinkfleet.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("thinkfleet hooks list")}`,
      `  ${formatCliCommand("thinkfleet hooks enable <name>")}`,
      `  ${formatCliCommand("thinkfleet hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
