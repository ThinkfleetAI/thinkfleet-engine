...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "thinkfleet-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<ThinkfleetConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<ThinkfleetConfig["telegram"]>>,
