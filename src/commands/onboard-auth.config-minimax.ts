...
export function applyMinimaxProviderConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyMinimaxConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
