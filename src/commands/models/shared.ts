...
export async function updateConfig(
  mutator: (cfg: ThinkfleetConfig) => ThinkfleetConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: ThinkfleetConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: ThinkfleetConfig): Set<string> {
