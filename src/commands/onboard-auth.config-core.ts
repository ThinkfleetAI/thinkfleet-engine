...
export function applyZaiConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyOpenrouterProviderConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyOpenrouterConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyMoonshotProviderConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyKimiCodeProviderConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applySyntheticProviderConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
