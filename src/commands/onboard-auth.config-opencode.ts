...
export function applyOpencodeZenProviderConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
...
export function applyOpencodeZenConfig(cfg: ThinkfleetConfig): ThinkfleetConfig {
