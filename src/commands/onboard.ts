  ...
  if (normalizedOpts.nonInteractive && normalizedOpts.acceptRisk !== true) {
    runtime.error(
      [
        ...
        "Read: https://docs.thinkfleet.ai/security",
        `Re-run with: ${formatCliCommand("thinkfleet onboard --non-interactive --accept-risk ...")}`,
      ].join("\n"),
    );
    runtime.exit(1);
    return;
  ...
  if (process.platform === "win32") {
    runtime.log(
      [
        ...
        "Guide: https://docs.thinkfleet.ai/windows",
      ].join("\n"),
    );
  }
