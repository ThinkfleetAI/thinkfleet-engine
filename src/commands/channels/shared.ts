...
import { type ThinkfleetConfig, readConfigFileSnapshot } from "../../config/config.js";
...
export async function requireValidConfig(
  ...
  if (snapshot.exists && !snapshot.valid) {
    ...
    runtime.error(`Fix the config or run ${formatCliCommand("thinkfleet doctor")}.`);
    runtime.exit(1);
    return null;
  }
