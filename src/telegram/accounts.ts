...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.THINKFLEET_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ThinkfleetConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ThinkfleetConfig): string {
...
export function listEnabledTelegramAccounts(cfg: ThinkfleetConfig): ResolvedTelegramAccount[] {
