...
import {
  ...
  type ThinkfleetPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @thinkfleet/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageThinkfleet: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverThinkfleetPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".thinkfleet", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
