...
export function listChannelMessageActions(cfg: ThinkfleetConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ThinkfleetConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: ThinkfleetConfig): boolean {
  for (const plugin of listChannelPlugins()) {
