...
export type ChannelAgentToolFactory = (params: { cfg?: ThinkfleetConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ThinkfleetConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ThinkfleetConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ThinkfleetConfig }) => boolean;
  supportsCards?: (params: { cfg: ThinkfleetConfig }) => boolean;
