...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ThinkfleetConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ThinkfleetConfig; env: NodeJS.ProcessEnv }): {
  cfg: ThinkfleetConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
