...
export DISPLAY=:1
export HOME=/tmp/thinkfleetbot-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${THINKFLEETBOT_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${THINKFLEETBOT_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${THINKFLEETBOT_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${THINKFLEETBOT_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${THINKFLEETBOT_BROWSER_HEADLESS:-0}"
