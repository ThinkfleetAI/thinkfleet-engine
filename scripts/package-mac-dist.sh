...
#
# Output:
# - dist/ThinkFleetBot.app
# - dist/ThinkFleetBot-<version>.zip
# - dist/ThinkFleetBot-<version>.dmg
...
APP="$ROOT_DIR/dist/ThinkFleetBot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ThinkFleetBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/ThinkFleetBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ThinkFleetBot-$VERSION.notary.zip"
