...
if [[ -z "$version_content" ]]; then
  echo "<h2>ThinkFleetBot $VERSION</h2>"
  echo "<p>Latest ThinkFleetBot update.</p>"
  echo "<p><a href=\"https://github.com/thinkfleetbot/thinkfleet-engine/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
