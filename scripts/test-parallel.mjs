...
const shardOverride = Number.parseInt(process.env.THINKFLEETBOT_TEST_SHARDS ?? "", 10);
...
const overrideWorkers = Number.parseInt(process.env.THINKFLEETBOT_TEST_WORKERS ?? "", 10);
