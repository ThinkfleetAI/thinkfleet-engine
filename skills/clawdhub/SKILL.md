...
metadata: {"thinkfleetbot":{"requires":{"bins":["clawdhub"]},"install":[{"id":"node","kind":"node","package":"clawdhub","bins":["clawdhub"],"label":"Install ClawdHub CLI (npm)"}]}}
---
...
- Default workdir: cwd (falls back to ThinkFleetBot workspace); install dir: ./skills (override with --workdir / --dir / CLAWDHUB_WORKDIR)
