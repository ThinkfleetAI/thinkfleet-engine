...
Display HTML content on connected ThinkFleetBot nodes (Mac app, iOS, Android).
...
```
http://<tailscale-hostname>:18793/__thinkfleetbot__/canvas/<file>.html
```
...
In `~/.thinkfleetbot/thinkfleetbot.json`:
...
```bash
cat ~/.thinkfleetbot/thinkfleetbot.json | jq '.gateway.bind'
```

Then construct the URL:
- **loopback**: `http://127.0.0.1:18793/__thinkfleetbot__/canvas/<file>.html`
- **lan/tailnet/auto**: `http://<hostname>:18793/__thinkfleetbot__/canvas/<file>.html`
...
**Example:**
```
canvas action:present node:mac-63599bc4-b54d-4392-9048-b97abd58343a target:http://peters-mac-studio-1.sheep-coho.ts.net:18793/__thinkfleetbot__/canvas/snake.html
```
...
**Debug steps:**
1. Check server bind: `cat ~/.thinkfleetbot/thinkfleetbot.json | jq '.gateway.bind'`
2. Check what port canvas is on: `lsof -i :18793`
3. Test URL directly: `curl http://<hostname>:18793/__thinkfleetbot__/canvas/<file>.html`
...
Node is offline. Use `thinkfleetbot nodes list` to find online nodes.
