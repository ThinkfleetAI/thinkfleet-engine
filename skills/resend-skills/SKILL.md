...
| **AI Agent inbox** | `agent-inbox` | Setting up email for AI agents with security measures against prompt injection |
...
**Setting up an AI agent inbox?** Use `agent-inbox` skill
