...
metadata: {"thinkfleetbot":{"emoji":"🔊","requires":{"bins":["curl"],"env":["OPENAI_API_KEY"]},"primaryEnv":"OPENAI_API_KEY"}}
---
...
Set `OPENAI_API_KEY`, or configure in `~/.thinkfleetbot/thinkfleetbot.json`:
