...
declare global {
  interface Window {
    __THINKFLEETBOT_CONTROL_UI_BASE_PATH__?: string;
  }
}
...
@customElement("thinkfleetbot-app")
export class ThinkFleetBotApp extends LitElement {
  ...
  @state() setupWizardMode: "standalone" | "saas" | null = null;
  @state() setupWizardLoading = false;
  @state() setupWizardSessionId: string | null = null;
  @state() setupWizardVersion = "";
  @state() setupWizardProvider = "";
  @state() setupWizardApiKey = "";
  @state() setupWizardApiKeyValid: boolean | null = null;
