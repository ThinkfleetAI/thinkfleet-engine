...
declare global {
  interface Window {
    __THINKFLEETBOT_ASSISTANT_NAME__?: string;
    __THINKFLEETBOT_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__THINKFLEETBOT_ASSISTANT_NAME__,
    avatar: window.__THINKFLEETBOT_ASSISTANT_AVATAR__,
  });
}
