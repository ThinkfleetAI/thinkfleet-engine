...
export function connectGateway(host: GatewayHost) {
  ...
  host.client = new GatewayBrowserClient({
    ...
    clientName: "thinkfleetbot-control-ui",
    mode: "webchat",
    onHello: (hello) => {
      host.connected = true;
      host.lastError = null;
      ...
      void loadAssistantIdentity(host as unknown as ThinkFleetBotApp);
      void loadAgents(host as unknown as ThinkFleetBotApp);
...
function handleGatewayEventUnsafe(host: GatewayHost, evt: GatewayEventFrame) {
  ...
  if (evt.event === "chat") {
    ...
    const state = handleChatEvent(host as unknown as ThinkFleetBotApp, payload);
    ...
    if (state === "final") void loadChatHistory(host as unknown as ThinkFleetBotApp);
    return;
  }
