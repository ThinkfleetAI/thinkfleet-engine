...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("config")).toContain("thinkfleetbot.json");
  });
});
...
describe("normalizeBasePath", () => {
  ...
  it("handles nested paths", () => {
    expect(normalizeBasePath("/apps/thinkfleetbot")).toBe("/apps/thinkfleetbot");
  });
});
...
describe("pathForTab", () => {
  ...
  it("prepends base path", () => {
    ...
    expect(pathForTab("sessions", "/apps/thinkfleetbot")).toBe("/apps/thinkfleetbot/sessions");
  });
});
...
describe("tabFromPath", () => {
  ...
  it("handles base paths", () => {
    ...
    expect(tabFromPath("/apps/thinkfleetbot/sessions", "/apps/thinkfleetbot")).toBe("sessions");
  });
...
describe("inferBasePathFromPathname", () => {
  ...
  it("infers base path from nested paths", () => {
    ...
    expect(inferBasePathFromPathname("/apps/thinkfleetbot/sessions")).toBe("/apps/thinkfleetbot");
  });
