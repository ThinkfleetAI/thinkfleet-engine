        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src="https://mintcdn.com/thinkfleet-hub/4rYvG-uuZrMK_URE/assets/pixel-lobster.svg?fit=max&auto=format&n=4rYvG-uuZrMK_URE&q=85&s=da2032e9eac3b5d9bfe7eb96ca6a8a26" alt="ThinkFleetBot" />
            </div>
            <div class="brand-text">
              <div class="brand-title">THINKFLEETBOT</div>
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            <a
              ...
              href="https://docs.thinkfleet.dev"
              target="_blank"
              rel="noreferrer"
